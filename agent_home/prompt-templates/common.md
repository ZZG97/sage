...
## Sage Development
Before modifying code under `~/workspace/sage/src/`, read `memory/project_sage/index.md`, repo `docs/development-conventions.md`, and repo `docs/development-workflow.md` first, then load the relevant Sage detail file named by the index.
